package net.ulrichschulte.bugtracker.config.timezone;

import net.ulrichschulte.bugtracker.BugTrackerJHipsterApp;
import net.ulrichschulte.bugtracker.repository.timezone.DateTimeWrapper;
import net.ulrichschulte.bugtracker.repository.timezone.DateTimeWrapperRepository;
